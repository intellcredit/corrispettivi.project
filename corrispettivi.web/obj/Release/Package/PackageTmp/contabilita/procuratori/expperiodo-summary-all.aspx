<%@ Page Title="" Language="C#" MasterPageFile="~/SiteExport.master" AutoEventWireup="true" CodeBehind="expperiodo-summary-all.aspx.cs" Inherits="corrispettivi.web.contabilita.procuratori.expperiodo_summary_all" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="exportMain" Runat="Server">
        ...
        <MasterTableView AutoGenerateColumns="false" TableLayout="Fixed">
                ...
                <telerik:GridTemplateColumn ItemStyle-CssClass="testonero12" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="400px">
                    <ItemTemplate>
                        <table border="0" style="border-color:White" cellpadding="1" cellspacing="1" class="testonero12" width="400px" >
                            ...
                            <tr><td align="right"><b>Agente:</b></td><td><%# Eval("AgenteGroupNome")%></td></tr>
            ...
            <NestedViewTemplate>
                <asp:Panel runat="server" ID="InnerContainer" CssClass="viewWrap">
                    ...
                    <asp:SqlDataSource ID="sdsSummary" runat="server" ProviderName="System.Data.SqlClient" SelectCommand="summaryContabilitaProduratorixPeriodo" SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:dbConn%>" >
                        <SelectParameters>
                    ...
                    <asp:SqlDataSource ID="sdsAnticipato" runat="server" ProviderName="System.Data.SqlClient" SelectCommand="anticipatoContabilitaProduratorixPeriodo" SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:dbConn%>" >
                        <SelectParameters>
                            <asp:ControlParameter ControlID="lblPeriodoRif" PropertyName="Text" Type="String" Name="PeriodoRif" />
                            <asp:ControlParameter ControlID="lblAgenteGroupID" PropertyName="Text" Type="String" Name="AgenteGroupID" />
                        </SelectParameters>
    ...
    <asp:SqlDataSource ID="sdsInfo" runat="server" ProviderName="System.Data.SqlClient" ConnectionString="<%$ ConnectionStrings:dbConn%>" 
                    SelectCommandType="StoredProcedure" SelectCommand="pivotContabilitaProduratorixPeriodo">
        <SelectParameters>
