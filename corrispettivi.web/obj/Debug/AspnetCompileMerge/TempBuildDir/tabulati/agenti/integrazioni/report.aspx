<%@ Page Title="" Language="C#" MasterPageFile="~/tabulati/agenti/integrazioni/local.master" AutoEventWireup="true" CodeBehind="report.aspx.cs" Inherits="corrispettivi.web.tabulati.agenti.integrazioni.report" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <table border="0" cellpadding="2" cellspacing="2">
        <tr valign="middle">
            ...
            <td width="100%" align="right"><telerik:radtoolbar ID="tbAction" runat="server" 
                    Skin="Simple" onbuttonclick="tbAction_ButtonClick">
                    <Items>
    ...
    <telerik:RadGrid ID="gvInfo" runat="server" Skin="Simple" AllowPaging="false" AllowSorting="True" AllowFilteringByColumn="true" CellSpacing="0" GridLines="None" PageSize="100" DataSourceID="sdsInfo" Height="550px" ShowFooter="true">
        ...
        <MasterTableView AutoGenerateColumns="false" TableLayout="Fixed" DataKeyNames="AgenteIntegrazioneID">
            <ColumnGroups>
                <telerik:GridColumnGroup Name="Importi" HeaderText="Importi" HeaderStyle-HorizontalAlign="Center" />
                <telerik:GridColumnGroup Name="Giorni" HeaderText="Giorni" HeaderStyle-HorizontalAlign="Center" />
            </ColumnGroups>
            <Columns>
                <telerik:GridHyperLinkColumn AllowFiltering="False" AllowSorting="False" HeaderText="" ImageUrl="~/image/list.png" DataNavigateUrlFields="PeriodoRif,AgenteGroupID,AgenteGroupNome,OreContratto,AgenteIntegrazioneID" DataNavigateUrlFormatString="dettaglio.aspx?x={0}&y={1}&z={2}&o={3}&key={4}" HeaderStyle-Width="20px" ItemStyle-Width="20px" ItemStyle-HorizontalAlign="Center" />
                <telerik:GridHyperLinkColumn AllowFiltering="False" AllowSorting="False" HeaderText="" ImageUrl="~/image/Excel.gif" DataNavigateUrlFields="PeriodoRif,AgenteGroupAlias,AgenteIntegrazioneID" DataNavigateUrlFormatString="expdettaglio.aspx?x={0}&y={1}&key={2}&mode=xls" HeaderStyle-Width="20px" ItemStyle-Width="20px" ItemStyle-HorizontalAlign="Center" />
                ...
                <telerik:GridBoundColumn DataField="OreContratto" HeaderText="Ore<br />ctr" HeaderStyle-Width="50px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                    <FilterTemplate>
                        <telerik:RadComboBox RenderMode="Lightweight" ID="OreContrattoCombo" DataSourceID="sdsOreContratto" DataTextField="OreContratto" Skin="Black" Filter="Contains"
                            DataValueField="OreContratto" Height="100px" Width="50px" AppendDataBoundItems="true" SelectedValue='<%# ((GridItem)Container).OwnerTableView.GetColumn("OreContratto").CurrentFilterValue %>'
    ...
    <asp:SqlDataSource ID="sdsInfo" runat="server" ProviderName="System.Data.SqlClient" SelectCommand="xAgentiIntegrazioniView" SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:dbConn%>" >
        <SelectParameters>
