...
{
    public class AgentiIntegrazioni
    {
        public static DataTable Contratti(int _id)
        {
            ...
            try
            {
                ...
                //COMMAND
                _cmm = new SqlCommand();
                _cmm.CommandText = "xAgentiIntegrazioniContrattiView";
        ...
        public static DataTable ContrattiDettaglio(int _id)
        {
            ...
            try
            {
                ...
                //COMMAND
                _cmm = new SqlCommand();
                _cmm.CommandText = "xAgentiIntegrazioniContrattiDettaglioView";
                _cmm.Connection = _cnn;
                _cmm.CommandType = CommandType.StoredProcedure;

                _cmm.Parameters.Add(new SqlParameter("@AgenteIntegrazioneContrattoID", _id));
        ...
        public static Result.Default ManualSingleElab(int _agentegroupid, string _periodorif)
        {
            ...
            try
            {
                ...
                //COMMAND
                _cmm = new SqlCommand();
                _cmm.CommandText = "xAgentiIntegrazioniSingleExec";
                _cmm.Connection = _cnn;
                _cmm.CommandType = CommandType.StoredProcedure;
