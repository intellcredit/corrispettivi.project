<%@ Page Title="" Language="C#" MasterPageFile="~/settings/bc-cm/local.master" AutoEventWireup="true" CodeBehind="scheda.aspx.cs" Inherits="corrispettivi.web.settings.bc_cm.scheda" %>
...
//                    msg = msg.concat("- Verificare l`importo del compenso\n");
    ...
    <table border="0" cellpadding="2" cellspacing="2">
        <tr>
            ...
            <td align="right" width="100px">ore:</td>
            <td colspan="2"><telerik:RadComboBox ID="cmbOreContratto" runat="server" Width="700px" EmptyMessage="selezionare un valore">
                <Items>
