...
{
    public class paramBcCompensiSettimanali
    {
        public static DataTable read(int _id)
        {
            ...
            try
            {
                ...
                //COMMAND
                _cmm = new SqlCommand();
                _cmm.CommandText = "xParamBcCompensiSettimanaliRead";
                _cmm.Connection = _cnn;
                _cmm.CommandType = CommandType.StoredProcedure;

                _cmm.Parameters.Add(new SqlParameter("@paramBcCompensoSettimanaleID", _id));
        ...
        public static DataTable view(int _idsocieta, int _idbase)
        {
            ...
            try
            {
                ...
                //COMMAND
                _cmm = new SqlCommand();
                _cmm.CommandText = "xParamBcCompensiSettimanaliView";
                _cmm.Connection = _cnn;
                _cmm.CommandType = CommandType.StoredProcedure;
        ...
        public static Result.Default write(int _id, string _desc, int _cntmin, int _cntmax, double _comp, DateTime _dtinizio, DateTime? _dtfine, string _note, string _utente)
        {
            ...
            try
            {
                ...
                //COMMAND
                _cmm = new SqlCommand();
                _cmm.CommandText = "xParamBcCompensiSettimanaliWrite";
                _cmm.Connection = _cnn;
                _cmm.CommandType = CommandType.StoredProcedure;

                _cmm.Parameters.Add(new SqlParameter("@Descrizione", _desc));
                ...
                parID = new SqlParameter("@paramBcCompensoSettimanaleID", SqlDbType.Int);
        ...
        public static Result.Default delete(int _id, string _utente)
        {
            ...
            try
            {
                ...
                //COMMAND
                _cmm = new SqlCommand();
                _cmm.CommandText = "xParamBcCompensiSettimanaliDelete";
                _cmm.Connection = _cnn;
                _cmm.CommandType = CommandType.StoredProcedure;
        ...
        public static Result.Default checkrange(int _id, string _desc, DateTime _dtinizio, DateTime? _dtfine)
        {
            Result.Default _result = new Result.Default();
            ...
            try
            {
                ...
                //COMMAND
                _cmm = new SqlCommand();
                _cmm.CommandText = "xParamBcCompensiSettimanaliCheckRange";
                _cmm.Connection = _cnn;
                _cmm.CommandType = CommandType.StoredProcedure;
