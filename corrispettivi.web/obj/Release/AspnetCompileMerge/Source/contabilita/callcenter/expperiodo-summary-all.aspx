<%@ Page Title="" Language="C#" MasterPageFile="~/SiteExport.master" AutoEventWireup="true" CodeBehind="expperiodo-summary-all.aspx.cs" Inherits="corrispettivi.web.contabilita.callcenter.expperiodo_summary_all" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="exportMain" Runat="Server">
    ...
    <asp:SqlDataSource ID="sdsInfo" runat="server" ProviderName="System.Data.SqlClient" ConnectionString="<%$ ConnectionStrings:dbConn%>" 
                    SelectCommandType="StoredProcedure" SelectCommand="pivotContabilitaCallCenterxPeriodo">
        <SelectParameters>
