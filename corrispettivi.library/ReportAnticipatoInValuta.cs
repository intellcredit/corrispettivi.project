...
{
    public class ReportAnticipatoInValuta
    {
        public static DataTable AgenteGroupID(int _agentegroupid, string _periodorif)
        {
            ...
            try
            {
                ...
                //COMMAND
                _cmm = new SqlCommand();
                _cmm.CommandText = "anticipatoAgenteGroupxPeriodo";
