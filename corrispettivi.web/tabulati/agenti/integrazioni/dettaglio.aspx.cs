...
namespace corrispettivi.web.tabulati.agenti.integrazioni
{
    public partial class dettaglio : System.Web.UI.Page
    {
        ...
        protected void gvInfo_DetailTableDataBind(object source, Telerik.Web.UI.GridDetailTableDataBindEventArgs e)
        {
            ...
            string id = dataItem.GetDataKeyValue("AgenteIntegrazioneContrattoID").ToString();
            e.DetailTableView.DataSource = AgentiIntegrazioni.ContrattiDettaglio(Convert.ToInt32(id));
        }
    }
}