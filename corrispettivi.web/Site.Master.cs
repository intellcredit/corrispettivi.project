    ...
    public partial class mSite : System.Web.UI.MasterPage
    {
        ...
        protected void Page_Load(object sender, System.EventArgs e)
        {
            if (Page.IsPostBack != true)
            {
                ...
                {
                    mMainMenu.FindItemByText("Report").Visible = true;
                    mMainMenu.FindItemByText("Settings").Visible = true;
                    mMainMenu.FindItemByText("Elaborazione manuale singolo agente").Visible = true;
                    mMainMenu.FindItemByValue("sep5").Visible = true;
                    mMainMenu.FindItemByText("Call center. Report per email").Visible = true;
                    mMainMenu.FindItemByValue("sep7").Visible = true;
                }
                else
                {
                    mMainMenu.FindItemByText("Report").Visible = false;
                    mMainMenu.FindItemByText("Settings").Visible = false;
                    mMainMenu.FindItemByText("Elaborazione manuale singolo agente").Visible = false;
                    mMainMenu.FindItemByValue("sep5").Visible = false;
                    mMainMenu.FindItemByText("Call center. Report per email").Visible = false;
                    mMainMenu.FindItemByValue("sep7").Visible = false;
                }
            }
        }
