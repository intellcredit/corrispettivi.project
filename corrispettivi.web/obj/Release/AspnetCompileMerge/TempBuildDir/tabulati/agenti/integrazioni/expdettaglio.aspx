<%@ Page Title="" Language="C#" MasterPageFile="~/SiteExport.master" AutoEventWireup="true" CodeBehind="expdettaglio.aspx.cs" Inherits="corrispettivi.web.tabulati.agenti.integrazioni.expdettaglio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="exportMain" Runat="Server">
    ...
    <asp:SqlDataSource ID="sdsInfo" runat="server" ProviderName="System.Data.SqlClient" SelectCommand="xAgentiIntegrazioniContrattiDettaglioPrint" SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:dbConn%>" >
        <SelectParameters>
