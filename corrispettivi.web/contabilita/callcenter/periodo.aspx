<%@ Page Title="" Language="C#" MasterPageFile="~/contabilita/callcenter/local.master" AutoEventWireup="true" CodeBehind="periodo.aspx.cs" Inherits="corrispettivi.web.contabilita.callcenter.periodo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" Runat="Server">
    <h1><b>Call Center -> Report per periodo.</b></h1><hr />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <telerik:RadGrid ID="gvInfo" runat="server" DataSourceID="sdsInfo" Skin="Simple" AllowSorting="True" AllowFilteringByColumn="true" CellSpacing="0" GridLines="None" Height="550px" ShowFooter="true" OnItemDataBound="gvInfo_ItemDataBound" OnItemCommand="gvInfo_ItemCommand">
        ...
        <MasterTableView AutoGenerateColumns="false" TableLayout="Fixed" DataKeyNames="PeriodoRif,CallCenterID,StatusID,FatturaStatusID">
            <ItemStyle CssClass="testonero10" />
            <AlternatingItemStyle CssClass="testonero10" />
            <Columns>
                <telerik:GridBoundColumn DataField="CallCenterNome" HeaderText="Call Center" HeaderStyle-Width="300px" HeaderStyle-HorizontalAlign="Center" Aggregate="Count" FooterStyle-HorizontalAlign="Center">
                    <FilterTemplate>
                        <telerik:RadComboBox RenderMode="Lightweight" ID="CallCenterNomeCombo" DataSourceID="sdsCallCenter" DataTextField="CallCenterNome" Skin="Black" Filter="Contains"
                            DataValueField="CallCenterNome" Height="200px" Width="250px" DropDownWidth="300px" AppendDataBoundItems="true" 
                            SelectedValue='<%# ((GridItem)Container).OwnerTableView.GetColumn("CallCenterNome").CurrentFilterValue %>' 
                ...
                <telerik:RadTabStrip runat="server" ID="LoadTabStip" Skin="Simple" MultiPageID="LoadMultipage" SelectedIndex="0" Orientation="HorizontalTop" >
                    ...
                    <telerik:RadMultiPage runat="server" ID="LoadMultipage" SelectedIndex="0" RenderSelectedPageOnly="false">
                        <telerik:RadPageView runat="server" ID="rpvTabulati"> 
                            ...
                            <asp:SqlDataSource ID="sdsTabulati" runat="server" ProviderName="System.Data.SqlClient" SelectCommand="tabulatiContabilitaCallCenterxPeriodo" SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:dbConn%>" >
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="lblPeriodoRif" PropertyName="Text" Type="String" Name="PeriodoRif" />
                                    <asp:ControlParameter ControlID="lblCallCenterID" PropertyName="Text" Type="String" Name="CallCenterID" />
                                </SelectParameters>
                            </asp:SqlDataSource>
                        </telerik:RadPageView>
                        ...
                        <telerik:RadPageView runat="server" ID="rpvSummary">
                            ...
                            <asp:SqlDataSource ID="sdsAnticipato" runat="server" ProviderName="System.Data.SqlClient" SelectCommand="anticipatoContabilitaCallCenterxPeriodo" SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:dbConn%>" >
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="lblPeriodoRif" PropertyName="Text" Type="String" Name="PeriodoRif" />
                                    <asp:ControlParameter ControlID="lblCallCenterID" PropertyName="Text" Type="String" Name="CallCenterID" />
                                </SelectParameters>
                        ...
                        <telerik:RadPageView runat="server" ID="rpvFatture">
                            ...
                            <asp:SqlDataSource ID="sdsFatture" runat="server" ProviderName="System.Data.SqlClient" SelectCommand="fattureContabilitaCallCenterxPeriodo" SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:dbConn%>" >
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="lblPeriodoRif" PropertyName="Text" Type="String" Name="PeriodoRif" />
                                    <asp:ControlParameter ControlID="lblCallCenterID" PropertyName="Text" Type="String" Name="CallCenterID" />
                                </SelectParameters>
