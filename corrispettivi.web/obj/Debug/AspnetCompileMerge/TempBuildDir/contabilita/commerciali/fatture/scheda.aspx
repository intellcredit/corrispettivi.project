<%@ Page Title="" Language="C#" MasterPageFile="~/contabilita/commerciali/local.master" AutoEventWireup="true" CodeBehind="scheda.aspx.cs" Inherits="corrispettivi.web.contabilita.commerciali.fatture.scheda" %>
<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" Runat="Server">
    <h1><b>COMMERCIALI. REGISTRAZIONE FATTURE.</b></h1><hr />
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <table border="0" cellpadding="2" cellspacing="2" width="100%">
        <tr>
            <td align="right"><b>Commerciale</b></td>
            <td colspan="2"><telerik:RadComboBox ID="cmbCommerciale" runat="server" Width="550px" EmptyMessage="selezionare un valore" DataSourceID="sdsCommerciali" DataTextField="Nominativo" DataValueField="CommercialeID" Filter="Contains">
                <HeaderTemplate>
                    <ul>
                ...
                <ItemTemplate>
                    <ul>
                        <li class="colCodice"><%# DataBinder.Eval(Container.DataItem, "CommercialeID") %></li>
                        <li class="colDenominazione"><%# DataBinder.Eval(Container.DataItem, "Nominativo")%></li>
                    </ul>
                </ItemTemplate>
            </telerik:RadComboBox></td>
            <td rowspan="10" align="right" valign="top">&nbsp;</td>
        </tr>
    ...
    <asp:SqlDataSource ID="sdsInfo" runat="server" ProviderName="System.Data.SqlClient" SelectCommand="xFattureView" SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:dbConn%>" >
        <SelectParameters>
            <asp:QueryStringParameter QueryStringField="c" Name="CommercialeID" />
    ...
    <asp:SqlDataSource ID="sdsCommerciali" runat="server" ProviderName="System.Data.SqlClient" 
        SelectCommand="xCommercialiView" SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:dbConn%>" />
