<%@ Page Title="" Language="C#" MasterPageFile="~/settings/bc-cm/local.master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="corrispettivi.web.settings.bc_cm._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <telerik:RadGrid ID="gvInfo" runat="server" Skin="Simple" AllowPaging="True" AllowSorting="True" CellSpacing="0" GridLines="None" PageSize="25" DataSourceID="sdsInfo" Height="650px">
        ...
        <MasterTableView AutoGenerateColumns="false" TableLayout="Fixed" DataKeyNames="paramBcCompensoMensileID">
            <ColumnGroups>
            ...
            <Columns>
                <telerik:GridHyperLinkColumn AllowFiltering="False" AllowSorting="False" HeaderText="" ImageUrl="~/image/Modify.png" DataNavigateUrlFields="paramBcCompensoMensileID" DataNavigateUrlFormatString="scheda.aspx?id={0}" HeaderStyle-Width="20px" ItemStyle-Width="20px" ItemStyle-HorizontalAlign="Center" />
    ...
    <asp:SqlDataSource ID="sdsInfo" runat="server" ProviderName="System.Data.SqlClient" SelectCommand="xParamBcCompensiMensiliView" SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:dbConn%>" />
</asp:Content>