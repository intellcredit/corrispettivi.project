<%@ Page Title="" Language="C#" MasterPageFile="~/tabulati/agenti/bc/local.master" AutoEventWireup="true" CodeBehind="dettaglioWeek.aspx.cs" Inherits="corrispettivi.web.tabulati.agenti.bc.dettaglioWeek" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <telerik:RadGrid ID="gvInfo" runat="server" Skin="Simple" AllowSorting="True" CellSpacing="0" GridLines="None" DataSourceID="sdsInfo" Height="550px" ShowFooter="true" OnDetailTableDataBind="gvInfo_DetailTableDataBind">
        ...
        <MasterTableView AutoGenerateColumns="false" TableLayout="Fixed" DataKeyNames="AgenteBcPresenzeWeekID">
            <Columns>
                <telerik:GridBoundColumn DataField="WeekNum" HeaderText="Settimana" HeaderStyle-Width="40px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center" Aggregate="Count" FooterAggregateFormatString="Settimane: {0:d}" />
                <telerik:GridBoundColumn DataField="WeekStart" HeaderText="Inizio" HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:d}" FooterStyle-HorizontalAlign="Center" />
                <telerik:GridBoundColumn DataField="WeekEnd" HeaderText="Fine" HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:d}" FooterStyle-HorizontalAlign="Center" />
                <telerik:GridBoundColumn DataField="CntGgPresenze" HeaderText="Giorni." HeaderStyle-Width="65px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" Aggregate="Sum" FooterAggregateFormatString="Giorni: {0:d}" FooterStyle-HorizontalAlign="Center" />
                <telerik:GridBoundColumn DataField="CntPratCont" HeaderText="Pratiche" HeaderStyle-Width="65px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" Aggregate="Sum" FooterAggregateFormatString="Pratiche: {0:d}" FooterStyle-HorizontalAlign="Center" />
                <telerik:GridBoundColumn DataField="CntCont" HeaderText="Contatti" HeaderStyle-Width="65px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" Aggregate="Sum" FooterAggregateFormatString="Contatti: {0:d}" FooterStyle-HorizontalAlign="Center" />
                <telerik:GridBoundColumn DataField="Stato" HeaderText="Stato" HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" />
            </Columns>
            <DetailTables>
                <telerik:GridTableView Name="Dettaglio" DataKeyNames="AgenteBcPresenzaDettaglioID" AutoGenerateColumns="false" ShowFooter="true" TableLayout="Fixed" AllowFilteringByColumn="false" SkinID="Balck">
                    ...
                    <Columns>
                        <telerik:GridBoundColumn DataField="DataPresenza" HeaderText="Data" HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:d}" Aggregate="CountDistinct" FooterAggregateFormatString="Giorni: {0:d}" FooterStyle-HorizontalAlign="Center"  />
                        <telerik:GridBoundColumn HeaderText="Codice" DataField="AgenteID" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="150px" />
                        <telerik:GridBoundColumn HeaderText="Pratica" DataField="PraticaAlias" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="150px" Aggregate="CountDistinct" FooterAggregateFormatString="Pratiche: {0:d}"  />
                        <telerik:GridBoundColumn HeaderText="Cnt" DataField="ContattiEffettivi" HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:d}" Aggregate="Count" FooterAggregateFormatString="Contatti: {0:d}" FooterStyle-HorizontalAlign="Center" />
