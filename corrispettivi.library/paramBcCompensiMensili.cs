...
{
    public class paramBcCompensiMensili
    {
        public static DataTable read(int _id)
        {
            ...
            try
            {
                ...
                //COMMAND
                _cmm = new SqlCommand();
                _cmm.CommandText = "xParamBcCompensiMensiliRead";
                _cmm.Connection = _cnn;
                _cmm.CommandType = CommandType.StoredProcedure;

                _cmm.Parameters.Add(new SqlParameter("@paramBcCompensoMensileID", _id));
        ...
        public static DataTable view(int _idsocieta, int _idbase)
        {
            ...
            try
            {
                ...
                //COMMAND
                _cmm = new SqlCommand();
                _cmm.CommandText = "xParamBcCompensiMensiliView";
                _cmm.Connection = _cnn;
                _cmm.CommandType = CommandType.StoredProcedure;
        ...
        public static Result.Default write(int _id, int _orecontr, int _cntmin, int _cntmax, double _comp, DateTime _dtinizio, DateTime? _dtfine, string _note, string _utente)
        {
            ...
            try
            {
                ...
                //COMMAND
                _cmm = new SqlCommand();
                _cmm.CommandText = "xParamBcCompensiMensiliWrite";
                _cmm.Connection = _cnn;
                _cmm.CommandType = CommandType.StoredProcedure;
                ...
                parID = new SqlParameter("@paramBcCompensoMensileID", SqlDbType.Int);
        ...
        public static Result.Default delete(int _id, string _utente)
        {
            ...
            try
            {
                ...
                //COMMAND
                _cmm = new SqlCommand();
                _cmm.CommandText = "xParamBcCompensiMensiliDelete";
                _cmm.Connection = _cnn;
                _cmm.CommandType = CommandType.StoredProcedure;
        ...
        public static Result.Default checkrange(int _id, int _orecontr, DateTime _dtinizio, DateTime? _dtfine)
        {
            ...
            try
            {
                ...
                //COMMAND
                _cmm = new SqlCommand();
                _cmm.CommandText = "xParamBcCompensiMensiliCheckRange";
                _cmm.Connection = _cnn;
                _cmm.CommandType = CommandType.StoredProcedure;
