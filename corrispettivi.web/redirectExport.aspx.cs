...
{
    public partial class redirectExport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Page.IsPostBack != true)
            {
                if (Request.QueryString["type"] != null && Request.QueryString["area"] != null)
                {
                    ...
                    {
                        case 1:
                            url = Tabulati.UrlAgenti(Convert.ToInt32(Request.QueryString["type"]), Tabulati.UrlType.UrlExport);
                            ...
                            break;
                        case 2:
                            url = Tabulati.UrlCommerciali(Convert.ToInt32(Request.QueryString["type"]), Tabulati.UrlType.UrlExport);
                            break;
                    }
