<%@ Page Title="" Language="C#" MasterPageFile="~/SiteExport.master" AutoEventWireup="true" CodeBehind="expperiodo-summary-all.aspx.cs" Inherits="corrispettivi.web.uffpersonale.expperiodo_summary_all" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="exportMain" Runat="Server">
        ...
        <MasterTableView AutoGenerateColumns="false" TableLayout="Fixed">
            ...
            <NestedViewTemplate>
                <asp:Panel runat="server" ID="InnerContainer" CssClass="viewWrap">
                    ...
                    <asp:SqlDataSource ID="sdsSummary" runat="server" ProviderName="System.Data.SqlClient" SelectCommand="summaryContabilitaxPeriodo" SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:dbConn%>" >
                        <SelectParameters>
                    ...
                    <asp:SqlDataSource ID="sdsAnticipato" runat="server" ProviderName="System.Data.SqlClient" SelectCommand="anticipatoContabilitaxPeriodo" SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:dbConn%>" >
                        <SelectParameters>
                            <asp:ControlParameter ControlID="lblPeriodoRif" PropertyName="Text" Type="String" Name="PeriodoRif" />
                            <asp:ControlParameter ControlID="lblCallCenterID" PropertyName="Text" Type="String" Name="CallCenterID" />
                        </SelectParameters>
    ...
    <asp:SqlDataSource ID="sdsInfo" runat="server" ProviderName="System.Data.SqlClient" ConnectionString="<%$ ConnectionStrings:dbConn%>" 
                    SelectCommandType="StoredProcedure" SelectCommand="pivotContabilitaxPeriodo">
        <SelectParameters>
