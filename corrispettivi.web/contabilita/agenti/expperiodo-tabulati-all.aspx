<%@ Page Title="" Language="C#" MasterPageFile="~/SiteExport.master" AutoEventWireup="true" CodeBehind="expperiodo-tabulati-all.aspx.cs" Inherits="corrispettivi.web.contabilita.agenti.expperiodo_tabulati_all" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="exportMain" Runat="Server">
    ...
    <asp:SqlDataSource ID="sdsInfo" runat="server" ProviderName="System.Data.SqlClient" SelectCommand="pivotContabilitaAgentixPeriodo_ExportTabulati" SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:dbConn%>" >
        <SelectParameters>
