...
namespace corrispettivi.web.tabulati.agenti.corrispettivi
{
    public partial class dettaglio : System.Web.UI.Page
    {
        ...
        protected void gvInfo_DetailTableDataBind(object source, Telerik.Web.UI.GridDetailTableDataBindEventArgs e)
        {
            ...
            string id = dataItem.GetDataKeyValue("AgenteCorrispettivoPraticaID").ToString();
            e.DetailTableView.DataSource = AgentiCorrispettivi.PraticheDettalgio(Convert.ToInt32(id));
        }
    }
}