<%@ Page Title="" Language="C#" MasterPageFile="~/tabulati/agenti/bslintegr/local.master" AutoEventWireup="true" CodeBehind="scheda.aspx.cs" Inherits="corrispettivi.web.tabulati.agenti.bslintegr.scheda" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    <script type="text/javascript">
        ...
        function onToolBarClientButtonClicking(sender, args) {
            ...
            if ((button.get_commandName() == "SaveSelected") || (button.get_commandName() == "SaveCloseSelected")) {
                ...
                var comp = document.getElementById('<%=txtImporto.ClientID%>').value;
                if (comp == "0,00")
                    msg = msg.concat("- Verificare l`importo\n");
    ...
    <table border="0" cellpadding="2" cellspacing="2">
        ...
        <tr valign="top">
            ...
            <td align="right"></td>
            <td colspan="3"><telerik:RadNumericTextBox ID="txtImporto" runat="server" Value="0" NumberFormat-DecimalDigits="2" Width="75px" /></td>
        </tr>
        <tr><td colspan="5"><hr /></td></tr>
        <tr valign="top">
    ...
    <asp:SqlDataSource ID="sdsAgenti" runat="server" ProviderName="System.Data.SqlClient" SelectCommandType="Text" ConnectionString="<%$ ConnectionStrings:dbConn%>" 
        SelectCommand="select distinct AgenteGroupID, Nominativo as AgenteGroupNome, concat(Nominativo, ' (',AgenteGroupID,')') as AgenteGroupAlias 
            ...
            inner join paramCallCenter PCC on [AS].ID_CALLCENTER = PCC.CallCenterID 
            where PCC.execAgentiBsl = 1 order by AgenteGroupNome" />
