<%@ Page Title="" Language="C#" MasterPageFile="~/admin/local.master" AutoEventWireup="true" CodeBehind="repagexanno.aspx.cs" Inherits="corrispettivi.web.admin.repagexanno" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <table border="0" cellpadding="2" cellspacing="2">
        <tr valign="middle">
            ...
            <td><telerik:RadComboBox ID="cmbCallCenter" runat="server" Width="200px" EmptyMessage="Selezionare un valore..."
                    DataSourceID="sdsCallCenter" DataTextField="CallCenterNome" DataValueField="CallCenterID" AutoPostBack="true" 
                    onselectedindexchanged="cmbCallCenter_SelectedIndexChanged" /></td>
            ...
            <td width="100%" align="right"><telerik:radtoolbar ID="tbAction" runat="server" Skin="Simple">
                    <Items>
                        <telerik:RadToolBarDropDown Text="Esporta" Font-Bold="True" ImageUrl="~/image/Download-20.png"> 
                            <Buttons>
                                <telerik:RadToolBarButton Text="Csv" ImageUrl="~/image/csv.png" CommandName="expCsv" Value="exprepagexanno.aspx?mode=csv&x={0}&id={1}&name={2}" />
                                <telerik:RadToolBarButton Text="Excel" ImageUrl="~/image/excel.gif" CommandName="expExcel" Value="exprepagexanno.aspx?mode=xls&x={0}&id={1}&name={2}" />
                            </Buttons>
    ...
    <telerik:RadGrid ID="gvInfo" runat="server" DataSourceID="sdsInfo" Skin="Simple" CellSpacing="0" GridLines="None" Height="550px" ShowFooter="true" AllowFiltering="false" >
        ...
        <MasterTableView AutoGenerateColumns="false" TableLayout="Fixed" DataKeyNames="AgenteGroupID">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="AgenteGroupNome" HeaderText="Agente" HeaderStyle-Width="200px" HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center"
                                        Aggregate="Count"  />

                <telerik:GridHyperLinkColumn HeaderText="Gennaio" HeaderStyle-Width="70px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" 
                ...
                <telerik:GridHyperLinkColumn HeaderText="Febbraio" HeaderStyle-Width="70px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" 
                                        DataTextField="FEB_Totale"                       
                                        DataTextFormatString="{0:N}" 
                                        DataNavigateUrlFields="AnnoRif,FEB_Num,CallCenterID" 
                                        DataNavigateUrlFormatString="repagexperiodo.aspx?x={0}&y={1}&cc={2}" />

                <telerik:GridHyperLinkColumn HeaderText="Marzo" HeaderStyle-Width="70px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" 
                                        DataTextField="MAR_Totale"                       
                                        DataTextFormatString="{0:N}" 
                                        DataNavigateUrlFields="AnnoRif,MAR_Num,CallCenterID" 
                                        DataNavigateUrlFormatString="repagexperiodo.aspx?x={0}&y={1}&cc={2}" />

                <telerik:GridHyperLinkColumn HeaderText="Aprile" HeaderStyle-Width="70px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" 
                                        DataTextField="APR_Totale"                       
                                        DataTextFormatString="{0:N}" 
                                        DataNavigateUrlFields="AnnoRif,APR_Num,CallCenterID"  
                                        DataNavigateUrlFormatString="repagexperiodo.aspx?x={0}&y={1}&cc={2}" />

                <telerik:GridHyperLinkColumn HeaderText="Maggio" HeaderStyle-Width="70px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" 
                                        DataTextField="MAG_Totale"                       
                                        DataTextFormatString="{0:N}" 
                                        DataNavigateUrlFields="AnnoRif,MAG_Num,CallCenterID"
                                        DataNavigateUrlFormatString="repagexperiodo.aspx?x={0}&y={1}&cc={2}" />

                <telerik:GridHyperLinkColumn HeaderText="Giugno" HeaderStyle-Width="70px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" 
                                        DataTextField="GIU_Totale"                       
                                        DataTextFormatString="{0:N}" 
                                        DataNavigateUrlFields="AnnoRif,GIU_Num,CallCenterID"
                                        DataNavigateUrlFormatString="repagexperiodo.aspx?x={0}&y={1}&cc={2}" />

                <telerik:GridHyperLinkColumn HeaderText="Luglio" HeaderStyle-Width="70px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" 
                                        DataTextField="LUG_Totale"                       
                                        DataTextFormatString="{0:N}" 
                                        DataNavigateUrlFields="AnnoRif,LUG_Num,CallCenterID" 
                                        DataNavigateUrlFormatString="repagexperiodo.aspx?x={0}&y={1}&cc={2}" />

                <telerik:GridHyperLinkColumn HeaderText="Agosto" HeaderStyle-Width="70px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" 
                                        DataTextField="AGO_Totale"                       
                                        DataTextFormatString="{0:N}" 
                                        DataNavigateUrlFields="AnnoRif,AGO_Num,CallCenterID" 
                                        DataNavigateUrlFormatString="repagexperiodo.aspx?x={0}&y={1}&cc={2}" />

                <telerik:GridHyperLinkColumn HeaderText="Settembre" HeaderStyle-Width="70px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" 
                                        DataTextField="SET_Totale"                       
                                        DataTextFormatString="{0:N}" 
                                        DataNavigateUrlFields="AnnoRif,SET_Num,CallCenterID" 
                                        DataNavigateUrlFormatString="repagexperiodo.aspx?x={0}&y={1}&cc={2}" />

                <telerik:GridHyperLinkColumn HeaderText="Ottobre" HeaderStyle-Width="70px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" 
                                        DataTextField="OTT_Totale"                       
                                        DataTextFormatString="{0:N}" 
                                        DataNavigateUrlFields="AnnoRif,OTT_Num,CallCenterID"  
                                        DataNavigateUrlFormatString="repagexperiodo.aspx?x={0}&y={1}&cc={2}" />

                <telerik:GridHyperLinkColumn HeaderText="Novembre" HeaderStyle-Width="70px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" 
                                        DataTextField="NOV_Totale"                       
                                        DataTextFormatString="{0:N}" 
                                        DataNavigateUrlFields="AnnoRif,NOV_Num,CallCenterID" 
                                        DataNavigateUrlFormatString="repagexperiodo.aspx?x={0}&y={1}&cc={2}" />

                <telerik:GridHyperLinkColumn HeaderText="Dicembre" HeaderStyle-Width="70px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" 
                                        DataTextField="DIC_Totale"                       
                                        DataTextFormatString="{0:N}" 
                                        DataNavigateUrlFields="AnnoRif,DIC_Num,CallCenterID"  
                                        DataNavigateUrlFormatString="repagexperiodo.aspx?x={0}&y={1}&cc={2}" />
                
                <telerik:GridBoundColumn HeaderText="Totale" HeaderStyle-Width="70px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" 
