<%@ Page Title="" Language="C#" MasterPageFile="~/contabilita/procuratori/local.master" AutoEventWireup="true" CodeBehind="scheda.aspx.cs" Inherits="corrispettivi.web.contabilita.procuratori.fatture.scheda" %>
<%@ Register assembly="Telerik.Web.UI" namespace="Telerik.Web.UI" tagprefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHeader" Runat="Server">
    <h1>PROCURATORI<b>. REGISTRAZIONE FATTURE.</b></h1><hr />
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <table border="0" cellpadding="2" cellspacing="2" width="100%">
        <tr>
            ...
            <td colspan="2"><telerik:RadComboBox ID="cmbAgente" runat="server" Width="550px" EmptyMessage="selezionare un valore" DataSourceID="sdsAgenti" DataTextField="Nominativo" DataValueField="AgenteGroupID" Filter="Contains">
                <HeaderTemplate>
                    <ul>
                ...
                <ItemTemplate>
                    <ul>
                        <li class="colCodice"><%# DataBinder.Eval(Container.DataItem, "AgenteGroupID") %></li>
    ...
    <table border="0" cellpadding="0" cellspacing="0" bgcolor="#cccccc" width="100%">
        <tr><td align="right"><telerik:radtoolbar ID="tbAction2" runat="server" Skin="Simple" onbuttonclick="tbAction2_ButtonClick" OnClientButtonClicking="onToolBarClientButtonClicking">
            <Items>
                ...
                <telerik:RadToolBarButton Value="sep" IsSeparator="true" />
                <telerik:RadToolBarButton Text="Excel" ImageUrl="~/image/excel.gif" CommandName="ExportSelected" Value="expfatture.aspx?x={0}&y={1}&c={2}&a={3}" />
            </Items>
        </telerik:radtoolbar></td></tr>
    </table>
    ...
    <asp:SqlDataSource ID="sdsAgenti" runat="server" ProviderName="System.Data.SqlClient" 
        SelectCommand="xAgentiView" SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:dbConn%>" />
