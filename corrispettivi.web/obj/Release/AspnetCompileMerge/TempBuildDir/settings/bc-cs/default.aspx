<%@ Page Title="" Language="C#" MasterPageFile="~/settings/bc-cs/local.master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="corrispettivi.web.settings.bc_cs._default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <telerik:RadGrid ID="gvInfo" runat="server" Skin="Simple" AllowPaging="True" AllowSorting="True" CellSpacing="0" GridLines="None" PageSize="25" DataSourceID="sdsInfo" Height="650px">
        ...
        <MasterTableView AutoGenerateColumns="false" TableLayout="Fixed" DataKeyNames="paramBcCompensoSettimanaleID">
            <ColumnGroups>
            ...
            <Columns>
                <telerik:GridHyperLinkColumn AllowFiltering="False" AllowSorting="False" HeaderText="" ImageUrl="~/image/Modify.png" DataNavigateUrlFields="paramBcCompensoSettimanaleID" DataNavigateUrlFormatString="scheda.aspx?id={0}" HeaderStyle-Width="20px" ItemStyle-Width="20px" ItemStyle-HorizontalAlign="Center" />
            ...
            <GroupByExpressions>
                <telerik:GridGroupByExpression>
                    <SelectFields>
                        <telerik:GridGroupByField FieldAlias="Livello" FieldName="Descrizione" HeaderValueSeparator=" " />
                    </SelectFields>
                    <GroupByFields>
                        <telerik:GridGroupByField FieldName="Descrizione" />
                    </GroupByFields>
                </telerik:GridGroupByExpression>
            </GroupByExpressions>
        </MasterTableView>
    </telerik:RadGrid>
    <asp:SqlDataSource ID="sdsInfo" runat="server" ProviderName="System.Data.SqlClient" SelectCommand="xParamBcCompensiSettimanaliView" SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:dbConn%>" />
</asp:Content>