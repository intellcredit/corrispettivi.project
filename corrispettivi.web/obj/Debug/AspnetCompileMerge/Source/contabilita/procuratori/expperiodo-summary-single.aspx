<%@ Page Title="" Language="C#" MasterPageFile="~/SiteExport.master" AutoEventWireup="true" CodeBehind="expperiodo-summary-single.aspx.cs" Inherits="corrispettivi.web.contabilita.procuratori.expperiodo_summary_single" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="exportMain" Runat="Server">
    ...
    <asp:SqlDataSource ID="sdsInfo" runat="server" ProviderName="System.Data.SqlClient" ConnectionString="<%$ ConnectionStrings:dbConn%>" SelectCommandType="Text" 
                       SelectCommand="select AgenteGroupID, Nominativo as AgenteGroupNome, @PeriodoRif as PeriodoRif from Agenti where AgenteGroupID = @AgenteGroupID">
        <SelectParameters>
            <asp:QueryStringParameter QueryStringField="x" Name="PeriodoRif" />
            <asp:QueryStringParameter QueryStringField="y" Name="AgenteGroupID" />
        </SelectParameters>
