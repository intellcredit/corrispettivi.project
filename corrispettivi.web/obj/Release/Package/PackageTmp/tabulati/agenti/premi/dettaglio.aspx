<%@ Page Title="" Language="C#" MasterPageFile="~/tabulati/agenti/premi/local.master" AutoEventWireup="true" CodeBehind="dettaglio.aspx.cs" Inherits="corrispettivi.web.tabulati.agenti.premi.dettaglio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" Runat="Server">
    ...
    <telerik:RadGrid ID="gvInfo" runat="server" Skin="Simple" AllowFilteringByColumn="true" AllowSorting="True" GridLines="None" CellPadding="0" CellSpacing="1" BorderColor="Black" DataSourceID="sdsInfo" Height="550px" ShowFooter="true" OnDetailTableDataBind="gvInfo_DetailTableDataBind">
        ...
        <MasterTableView AutoGenerateColumns="false" TableLayout="Fixed" DataKeyNames="AgentePremioContrattoID" ShowGroupFooter="true" GroupsDefaultExpanded="false">
            <ColumnGroups>
            ...
            <DetailTables>
                <telerik:GridTableView Name="Dettaglio" DataKeyNames="AgentePremioContrattoDettaglioID" Width="100%" AutoGenerateColumns="false" ShowFooter="true" TableLayout="Fixed" AllowFilteringByColumn="false" SkinID="Balck">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn HeaderText="Pratica" DataField="PraticaAlias" HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
    ...
    <asp:SqlDataSource ID="sdsInfo" runat="server" ProviderName="System.Data.SqlClient" SelectCommand="xAgentiPremiContrattiView" SelectCommandType="StoredProcedure" ConnectionString="<%$ ConnectionStrings:dbConn%>" >
        <SelectParameters>
    ...
    <asp:SqlDataSource ID="sdsAgenti" runat="server" ProviderName="System.Data.SqlClient" SelectCommandType="Text" ConnectionString="<%$ ConnectionStrings:dbConn%>"
        SelectCommand="SELECT DISTINCT concat(AgenteNome,' (',AgenteID,')') as AgenteAlias FROM AgentiPremiContratti WHERE AgentePremioID = @AgentePremioID Order by AgenteAlias">
        <SelectParameters>
            <asp:QueryStringParameter QueryStringField="key" Name="AgentePremioID" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="sdsContratti" runat="server" ProviderName="System.Data.SqlClient" SelectCommandType="Text" ConnectionString="<%$ ConnectionStrings:dbConn%>"
        SelectCommand="select distinct ContrattoDescrizione FROM AgentiPremiContratti WHERE AgentePremioID = @AgentePremioID Order by ContrattoDescrizione">
        <SelectParameters>
            <asp:QueryStringParameter QueryStringField="key" Name="AgentePremioID" />
        </SelectParameters>
    </asp:SqlDataSource>
