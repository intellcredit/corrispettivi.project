<%@ Page Title="" Language="C#" MasterPageFile="~/admin/local.master" AutoEventWireup="true" CodeBehind="repagexperiodo.aspx.cs" Inherits="corrispettivi.web.admin.repagexperiodo" %>
            ...
            <td width="100%" align="right"><telerik:radtoolbar ID="tbAction" runat="server" Skin="Simple">
                    <Items>
                        <telerik:RadToolBarDropDown Text="Esporta" Font-Bold="True" ImageUrl="~/image/Download-20.png"> 
                            <Buttons>
                                <telerik:RadToolBarButton Text="Csv" ImageUrl="~/image/csv.png" CommandName="expCsv" Value="exprepagexperiodo.aspx?mode=csv&x={0}&id={1}&name={2}" />
                                <telerik:RadToolBarButton Text="Excel" ImageUrl="~/image/excel.gif" CommandName="expExcel" Value="exprepagexperiodo.aspx?mode=xls&x={0}&id={1}&name={2}" />
                            </Buttons>
