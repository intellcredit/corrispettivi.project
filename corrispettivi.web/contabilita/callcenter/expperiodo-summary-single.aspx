<%@ Page Title="" Language="C#" MasterPageFile="~/SiteExport.master" AutoEventWireup="true" CodeBehind="expperiodo-summary-single.aspx.cs" Inherits="corrispettivi.web.contabilita.callcenter.expperiodo_summary_single" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="exportMain" Runat="Server">
    ...
    <asp:SqlDataSource ID="sdsInfo" runat="server" ProviderName="System.Data.SqlClient" ConnectionString="<%$ ConnectionStrings:dbConn%>" SelectCommandType="Text" 
                        SelectCommand="select CallCenterID, Nominativo as CallCenterNome, @PeriodoRif as PeriodoRif from CallCenter where CallCenterID = @CallCenterID">
        <SelectParameters>
            <asp:QueryStringParameter QueryStringField="x" Name="PeriodoRif" />
            <asp:QueryStringParameter QueryStringField="y" Name="CallCenterID" />
        </SelectParameters>
