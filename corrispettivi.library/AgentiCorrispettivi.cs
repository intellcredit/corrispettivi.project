...
{
    public class AgentiCorrispettivi
    {
        public static DataTable Pratiche(int _id)
        {
            ...
            try
            {
                ...
                //COMMAND
                _cmm = new SqlCommand();
                _cmm.CommandText = "xAgentiCorrispettiviPraticheView";
                _cmm.Connection = _cnn;
                _cmm.CommandType = CommandType.StoredProcedure;

                _cmm.Parameters.Add(new SqlParameter("@AgenteCorrispettivoID", _id));
        ...
        public static DataTable PraticheDettalgio(int _id)
        {
            ...
            try
            {
                ...
                //COMMAND
                _cmm = new SqlCommand();
                _cmm.CommandText = "xAgentiCorrispettiviPraticheDettaglioView";
                _cmm.Connection = _cnn;
                _cmm.CommandType = CommandType.StoredProcedure;

                _cmm.Parameters.Add(new SqlParameter("@AgenteCorrispettivoPraticaID", _id));
        ...
        public static Result.Default ManualSingleElab(int _agentegroupid, string _periodorif)
        {
            ...
            try
            {
                ...
                //COMMAND
                _cmm = new SqlCommand();
                _cmm.CommandText = "xAgentiCorrispettiviSingleExec";
                _cmm.Connection = _cnn;
                _cmm.CommandType = CommandType.StoredProcedure;
